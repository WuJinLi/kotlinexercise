 ...
 * desc  :
 */
data class Kuaidi(var message: String, var nu: String, var ischeck: String, var condition: String, var com: String, var status: String, var state: String, var data: List<Data>) {
    /**
     * message : ok
     * nu : 3912540893693
     * ischeck : 1
    ...
    class Data(var time: String, var ftime: String, var context: String, var location: String) {
        /**
